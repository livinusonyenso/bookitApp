...
function AddRoom() {
  const [state,htmlFormData] = useActionState(createRoom, {});
  ...
  return (
    ...
    <div className="bg-white shadow-lg rounded-lg p-6 w-full">
        <form action={htmlFormData}>
          ...
          <div className="mb-4">
            <label htmlFor="avialablility" className="block text-gray-700 font-bold mb-2"
              >avialablility</label
            >
            <input
              type="text"
              ...
              name="avialablility"
              className="border rounded w-full py-2 px-3"
              placeholder="avialablility (Monday - Friday, 9am - 5pm)"
              required
            />
          </div>
